...
const BadgePreview: React.FC<Props> = ({ layout, badgeCount, pageCount }) => {
  const isPortrait = layout.includes('portrait');
  const cols = layout === '8-up' ? 2 : layout === '10-up' ? 2 : layout === '6-up-portrait' ? 3 : layout === '8-up-portrait' ? 4 : 3;
  const rows = layout === '8-up' ? 4 : layout === '10-up' ? 5 : layout === '6-up-portrait' ? 2 : layout === '8-up-portrait' ? 2 : 3;
