...
- **Current Version:** 1.41 (Badge Printing district-count fix: Status guard decoupled from dropdown, always-enabled Badge Status + Scope Total preview, manual-selection warning)
